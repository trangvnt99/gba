...
<BlackBox />
            <div className="main" >
                ...
                <div class="list">
                    <h1>Ngũ cốc đặc sản</h1>
                    <hr />
                    <div class="container">
                        <div class="image-container">
                            <img src={ngucoc1} alt="Your Image" class="image" />
                        </div>
                        <div class="text-container">
                            ...
                            <p class="description">
                                Ăn ngũ cốc nhiều tốt cho việc giảm cân                   </p>
                        </div>
                    </div>
...
export default SpecialtyCereals;